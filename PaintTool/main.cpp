	...
	LPARAM _lparam)
{
	...
	case WM_PAINT:
	{
		...
		if (g_pCanvas) //g_pCanvas != nullptr OR g_pcanvas
		{
			g_pCanvas->Draw(hdc);
		}
		EndPaint(_hwnd, &ps);
	...
	case WM_COMMAND:
	{
		...
		case ID_HELP_ABOUT:
		{
			MessageBox(_hwnd, L"This paint tool was developed by Matt", L"I'm Pretty cool", MB_OK | MB_ICONINFORMATION);
			break;
		}
		default:
			break;
	...
	case WM_LBUTTONDOWN:
	{
		...
		{
		case LINESHAPE:
			g_pShape = new CLine(0, 1, RGB(0, 255, 0));
